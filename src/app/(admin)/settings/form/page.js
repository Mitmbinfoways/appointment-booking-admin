              ...
              {formFields.map((field, index) => {
                ...
                return (
                  <div
                    ...
                    className={`flex items-center gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200 transition-all duration-150 ${
                      isDragging ? "opacity-40 border-dashed border-blue-400 bg-blue-50/20" : ""
                    }`}
                  >
                    {/* Drag Handle Grip Icon */}
                    <div className="text-gray-400 cursor-grab active:cursor-grabbing hover:text-gray-600 p-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 w-full">
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          required
                          className="w-full px-3 py-1.5 border border-gray-300 rounded text-sm focus:outline-none bg-white font-medium text-gray-800"
                        />
                      </div>
                      <div className="flex items-center gap-4">
                        <div className="flex-1">
                          ...
                          <select
                            ...
                            className="w-full px-3 py-1.5 border border-gray-300 rounded text-sm bg-white focus:outline-none font-medium text-gray-800"
                          >
                            {FIELD_TYPES.map((t) => (
                    ...
                    <button
                      ...
                      className="text-red-500 hover:text-red-700 transition-colors p-1.5 self-end md:self-center cursor-pointer"
                    >

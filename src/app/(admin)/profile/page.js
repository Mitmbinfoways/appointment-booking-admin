    ...
    try {
      ...
      if (res.status === 200 && res.data?.statusCode === 200) {
        ...
        const profileObj = {
          ...
          showApiCredentials:
            user.showApiCredentials ?? profileData.showApiCredentials ?? false,
        };
        setProfileData(profileObj);
        setOriginalProfileData(profileObj);
        setIsEditing(false);
  ...
  return (
    <>
      <PageMeta
        ...
        description="Edit account profile and security settings"
      />
      <PageBreadcrumb
        items={[
          { label: "Home", to: "/" },
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="flex items-center justify-between border-b border-gray-200 pb-4 mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Update your username, email address, and business properties.
              </p>
            </div>
            {!isEditing ? (
              <button
              ...
              {isEditing ? (
                <div>
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg text-sm focus:outline-none bg-white ${
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-theme-xs p-6 self-start">
          <div className="flex items-center justify-between border-b border-gray-200 pb-4 mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Reset your login credentials to protect your scheduling metrics.
              </p>
            </div>
            {!isEditingPassword ? (
              <button
        ...
        {profileData.role !== "SuperAdmin" &&
          profileData.role !== "superadmin" &&
          profileData.showApiCredentials && (
            <div className="bg-white rounded-lg border border-gray-200 shadow-theme-xs p-6 lg:col-span-2">
              <div className="border-b border-gray-200 pb-4 mb-6">
                ...
                <p className="text-sm text-gray-500">
                  Your unique Admin ID and Secret Key required for public client
                  booking integration and API requests.
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      <span>
                        {copiedField === "Admin ID" ? "Copied" : "Copy"}
                      </span>
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        handleCopy(profileData.secretKey, "Secret Key")
                      }
                      className="px-3.5 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none flex items-center gap-1.5 shrink-0 cursor-pointer transition-colors"
                    >
                      ...
                      <span>
                        {copiedField === "Secret Key" ? "Copied" : "Copy"}
                      </span>
                    </button>
                  </div>
                </div>

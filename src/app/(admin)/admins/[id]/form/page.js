                ...
                return (
                  ...
                  >
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex-1">
                          ...
                          <select
                            ...
                            className="w-full px-3 py-1.5 border border-gray-300 rounded text-sm bg-white focus:outline-none"
                          >
                            {FIELD_TYPES.map((t) => (
                    ...
                    <button
                      ...
                      className="text-red-500 hover:text-red-700 transition-colors p-1.5 self-end md:self-center"
                    >

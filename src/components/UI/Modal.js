...
export const CustomModal = ({
  ...
  const contentClasses = isFullscreen
    ? "w-full h-full"
    : `relative w-full ${maxWidth} mx-4 rounded-xl border border-gray-200 bg-white transition-all duration-300 ease-in-out shadow-2xl overflow-hidden`;
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white">
            ...
            {showCloseButton && (
              <button
                type="button"
                onClick={handleClose}
                className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-gray-400 transition-colors hover:bg-gray-200 hover:text-gray-700 cursor-pointer focus:outline-none"
              >
                <svg
                  width="18"
                  height="18"

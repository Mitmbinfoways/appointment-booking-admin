...
const AppSidebar = () => {
            ...
            <li key={nav.name} className="list-none">
              {nav.subItems ? (
                <button
                  ...
                  className={`menu-item group focus:outline-none ${openSubmenu && openSubmenu.index === index
                    ? "menu-item-active"
                    : "menu-item-inactive"
                ...
                >
                  <span
                    className={`menu-item-icon-size ${openSubmenu && openSubmenu.index === index
                  ...
                  {(isExpanded || isHovered || isMobileOpen) && (
                    <ChevronDownIcon
                      className={`ml-auto w-5 h-5 transition-transform duration-200 ${openSubmenu && openSubmenu.index === index
  ...
  return (
    ...
    >
      <div
        className={`py-3 md:py-6 flex items-center gap-2 ${!isExpanded && !isHovered ? "md:justify-center" : "justify-start"
          }`}
      >
        <Link
          href="/"
